...
export const initialPrestige: Prestige = {
  radiantCoins: 0,
  totalCoinsEarned: 0,
  purchasedPerks: [0]
}

export const perkDefinitions: Perk[] = [{
  id: 1,
  cost: 1000,
  description: "Reduce cost increase of enhanced buildings from 2x to 1.8x",
  requiresPerk: 0
}, {
  id: 2,
  cost: 10000,
  description: "Reduce cost increase of enhanced buildings from 1.8x to 1.6x",
  requiresPerk: 1
}]